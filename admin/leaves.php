            ...
            <main class="mn-inner">
                    <div class="content">
                        ...
                        <table>
                            ...
                            <tbody>
                                <?php $sql = "SELECT tblleaves.id as lid,tblemployees.FirstName,tblemployees.LastName,tblemployees.EmpId,tblemployees.id,tblleaves.LeaveType,tblleaves.PostingDate,tblleaves.Status,tblleaves.StatusHead from tblleaves join tblemployees on tblleaves.empid=tblemployees.id order by lid desc";
