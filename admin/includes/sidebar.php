                    ...
                    <div>
                        <ul>
							<li class="logo"><img src ="logo.png" width="40" height="40">
							</li>
                            ...
                            <li class="dropdown">
                                ...
                                <div class="dropdown-content">
                                    ...
                                    <a href="managedepartments.php">Manage Department</a>
                                </div>
                            </li>
                            <li class="dropdown">
                                <a href="javascript:void(0)" class="dropbtn">Leave Type</a>
                                <div class="dropdown-content">
                                    <a href="addleavetype.php">Add Leave Type</a>
